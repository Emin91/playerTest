module.exports = {
  ...
  rules: {
    ...
    eqeqeq: ['error', 'always'], // устранение небезопасных операторов равенства
    ...
    //*** Variables ***//
    'init-declarations': ['error', 'always'], // необходимо обеспечить инициализацию при объявлении
    ...
    'id-length': 'off', // эта опция обеспечивает минимальную и максимальную длину идентификатора (имена переменных, имена свойств и т. д.)
    ...
    indent: ['error', 4], // укажите ширину табуляции или пробела для вашего кода
    ...
    'no-negated-condition': 'off', // запрещать отрицательные условия
